...
namespace GP.Repository.Data
{
    public static class StoreContextSeed
    {
        public static async Task SeedAsync(StoreContext dbContext)
        {
            ...
            {
                var ProductsData = File.ReadAllText(Path.Combine(Directory.GetCurrentDirectory(),"Data","DataSeed","products.json"));
            ...
            {
                var DeliveryMethodData = File.ReadAllText(Path.Combine(Directory.GetCurrentDirectory(), "Data", "DataSeed", "delivery.json"));
